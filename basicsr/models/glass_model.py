...
class GLASSModel(SRModel):
    """GLASS model for image super-resolution.

    Overrides ``test`` to run inference by partitioning large inputs into
    overlapping tiles and stitching the outputs, keeping memory bounded.
    """
